...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <?php if ($perm['permissions'][0]['system/logs/ErrorLogs']['access'] == "true") { ?>
                <!-- Add or Edit Product Start -->
                <div class="add-edit-product-wrap col-12">

                    <div class="add-edit-product-form">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <h4 class="title"><?php echo $lang->words['Error Logs']['Error Log']; ?></h4>
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30" style="padding:0px;">
                                    <div class="box">
                                        <div class="box-body">
                                            <ul id="ListError" class="list-group" style="overflow-y: scroll; height: 250px; background-color:#1c1f2d;">
                                                <?php $logs->GetLogsData(); ?>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <?php if ($perm['permissions'][0]['system/logs/ErrorLogs']['access'] == "true" && $perm['permissions'][0]['system/logs/ErrorLogs']['modify'] == "true") { ?>
                                    <div class="col-lg-12 col-12 mb-30">
                                        <div class="d-flex justify-content-center col mbn-10">
                                            <button id="ClearLogs" class="button button-outline button-primary ml-5"><?php echo $lang->words['Error Logs']['Clear Log']; ?></button>
                                        </div>
                                    </div>
                                <?Php } ?>
                            </div>
