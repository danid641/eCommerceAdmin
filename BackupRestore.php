...
$logs = new Logs; ?>
<?php require_once 'assets/php/group.php'; ?>
<?php require_once 'assets/php/users.php'; ?>
<?php
...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <?php if ($perm['permissions'][0]['system/data/BackupRestore']['access'] == "true" && $perm['permissions'][0]['system/data/BackupRestore']['modify'] == "true") { ?>
                <!-- Add or Edit Product Start -->
                <div class="add-edit-product-wrap col-12">

                    <div class="add-edit-product-form">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <h4 class="title">Backup</h4>
                            <div class="row">
                                ...
                                <div class="col-lg-12  col-12 mb-30">
                                    <label for="">Backup Content</label>
                                    <label class="adomx-switch primary">
                                ...
                                <div class="d-flex justify-content-center col mbn-10">
                                    <button id="SaveSystemData" class="button button-outline button-primary">Backup Now</button>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-12 mb-30">
                                    <hr>
                                    <div class="d-flex justify-content-center col mbn-10">
                                        <button id="SaveSystemData" class="button button-outline button-primary">Restore</button>
                                    </div>
                                </div>
                            </div>
                        </form>
