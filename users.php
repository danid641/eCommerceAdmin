...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <?php if ($perm['permissions'][0]['system/users/Users']['access'] == "true") { ?>
                <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-vertical-middle">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?php echo $lang->words['users']['username']; ?></th>
                                        <th><?php echo $lang->words['users']['Group']; ?></th>
                                        <th><?php echo $lang->words['users']['Email']; ?></th>
                                        <th><?php echo $lang->words['users']['Date Added']; ?></th>
                                        <?php if ($perm['permissions'][0]['system/users/Users']['access'] == "true" && $perm['permissions'][0]['system/users/Users']['modify'] == "true") { ?>
                                            <th class="jsgrid-header-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
                                                <a href="insert/users.php"><i class="fa-solid fa-plus text-success h2 cursor-pointer"></i></a>
                                            </th>
                                        <?php } ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <?php foreach ($users->UsersData as $data) { ?>
                                        <tr data-UserColumnId="<?php echo $data['id']; ?>">
                                            <td><?php echo $data['id']; ?></td>
                                            <td><?php echo $data['username']; ?></td>
                                            <td><?Php echo $data['Group']; ?></td>
                                            <td><?php echo $data['email']; ?></td>
                                            <td><?php echo $data['Date Added']; ?></td>
                                            <?php if ($perm['permissions'][0]['system/users/Users']['access'] == "true" && $perm['permissions'][0]['system/users/Users']['modify'] == "true") { ?>
                                                <td class="action h4">
                                                    <div class="table-action-buttons">
                                                        <a class="edit button button-box button-xs button-info" href="update/users.php?UserName=<?Php echo $data['username']; ?>">
                                                            <i class="fa-solid fa-pen"></i>
                                                        </a>
                                                        <button id="DeleteUser" data-UserId="<?php echo $data['id']; ?>" class="delete button button-box button-xs button-danger">
