...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <?php if ($perm['permissions'][0]['catalog/Categories']['access'] == "true") { ?>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table table-vertical-middle">
                                <thead>
                                    <tr>
                                        <th><?php echo $lang->words['Categories']['id']; ?></th>
                                        <th><?php echo $lang->words['Categories']['Category Name']; ?></th>
                                ...
                                <tbody>
                                    <?php $Category->GetCategoryData(); ?>
                                    <?php foreach ($Category->CategoryData as $data) { ?>
                                        <tr data-CategoryColumnId="<?php echo $data['id']; ?>">
                                            <td><?php echo $data['id']; ?></td>
                                            <td><?php echo $data['Category Name']; ?></td>
                                            <?php if ($perm['permissions'][0]['catalog/Categories']['access'] == "true" && $perm['permissions'][0]['catalog/Categories']['modify'] == "true") { ?>
                                                <td class="action h4">
                                                    <div class="table-action-buttons">
                                                        <a class="edit button button-box button-xs button-info" href="update/Categories.php?CategoryName=<?php echo $data['Category Name']; ?>">
                                                            <i class="fa-solid fa-pen"></i>
                                                        </a>
                                                        <button id="DeleteCategory" data-CategoryId="<?php echo $data['id']; ?>" class="delete button button-box button-xs button-danger">
