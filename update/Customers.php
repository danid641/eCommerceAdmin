...
$customer->GetDataCustomersCondition("WHERE `username` = '$CustomerName'");
$customerData = $customer->CustomersData;
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30 d-none">
                                    <input class="form-control" id="InitialUsername" type="hidden" value="<?Php echo $customerData[0]['username']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Username:</label>
                                    <input class="form-control" id="Username" type="text" value="<?Php echo $customerData[0]['username']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">First Name:</label>
                                    <input class="form-control" id="FirstName" type="text" value="<?Php echo $customerData[0]['First Name']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Last Name:</label>
                                    <input class="form-control" id="LastName" type="text" value="<?Php echo $customerData[0]['Last Name']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">E-Mail:</label>
                                    <input class="form-control" id="EMail" type="text" value="<?Php echo $customerData[0]['email']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Telephone:</label>
                                    <input class="form-control" id="Telephone" type="number" value="<?Php echo $customerData[0]['Phone']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Fax:</label>
                                    <input class="form-control" id="Fax" type="number" value="<?Php echo $customerData[0]['Fax']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Password:</label>
                                    <input class="form-control" id="Password" type="password" value="<?Php echo $customerData[0]['password']; ?>">
                                    <input class="form-control" id="Cpassword" type="password" value="<?Php echo $customerData[0]['password']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Newsletter:</label>
                                    <select class="form-control select2" id="Newsletter">
                                        <option value="<?Php echo $customerData[0]['newsletter']; ?>"><?Php if ($customerData[0]['newsletter'] == 1) {
                                                                                                            echo 'Enabled';
                                                                                                        } else {
                                                                                                            echo "Disabled";
                                                                                                        } ?></option>
                            ...
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="UpdateCustomer" class="button button-outline button-primary">Save</button>
