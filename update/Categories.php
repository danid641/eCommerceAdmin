...
$category->GetCategoryDataCondition("WHERE `Category Name` = '$CategoryName'");
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30 d-none">
                                    ...
                                    <input class="form-control d-none" id="InitialCategoryName" type="hidden" value="<?Php echo $categoryData[0]['Category Name']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Category Name:</label>
                                    <input class="form-control" id="CategoryName" type="text" value="<?Php echo $categoryData[0]['Category Name']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Description:</label>
                                    <input class="form-control" id="Description" type="text" value="<?Php echo $categoryData[0]['Description']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30">
                                    ...
                                    <input class="form-control" id="MetaTagKeywords" type="text" value="<?Php echo $categoryData[0]['Meta Tag Keywords']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Meta Tag Description:</label>
                                    <input class="form-control" id="MetaTagDescription" type="text" value="<?Php echo $categoryData[0]['Meta Tag Description']; ?>">
                                </div>
                            </div>
                            <!-- Button Group Start -->
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="UpdateCategory" class="button button-outline button-primary">Save</button>
