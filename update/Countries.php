...
if (isset($_GET['CountryName'])) {
    $countyName = $_GET['CountryName'];
}

$country->GetCountriesDataCondition("WHERE `Country Name` = '$countyName'");
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30 d-none">
                                    ...
                                    <input class="form-control" id="InitialCountryName" type="text" value="<?Php echo $countyName; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Country Name:</label>
                                    <input class="form-control" id="CountryName" type="text" value="<?Php echo $data[0]['Country Name']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">ISO Code:</label>
                                    <input class="form-control" id="ISOCode" type="text" value="<?Php echo $data[0]['ISO Code']; ?>">
                                </div>
                            </div>
                            <!-- Button Group Start -->
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="UpdateCountry" class="button button-outline button-primary">Save</button>
