...
if (isset($_GET['CurencyName'])) {
    $CurencyName = $_GET['CurencyName'];
}

$curency->GetCurrencyDataCondition("WHERE `Currency Title` = '$CurencyName'");
$curencyData = $curency->currenciesData;
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-12 col-12 mb-30">
                                ...
                                <input class="form-control" id="CurrencyTitle" type="text" value="<?Php echo $curencyData[0]['Currency Title']; ?>">
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                                <label for="">Code:</label>
                                <input class="form-control" id="Code" type="text" value="<?Php echo $curencyData[0]['Code']; ?>">
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                                <label for="">Value:</label>
                                <input class="form-control" id="Value" type="number" value="<?Php echo $curencyData[0]['Value']; ?>">
                            </div>
                        </div>
                        <!-- Button Group Start -->
                        <div class="row">
                            <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                <button id="UpdateCurrency" class="button button-outline button-primary">Save</button>
