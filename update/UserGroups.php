...
$Group->GetGroupDataCondition("WHERE `User Group Name` = '$GroupName'");
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30 d-none">
                                    <input class="form-control d-none" id="InitialGroupName" type="hidden" value="<?Php echo $GroupData[0]['User Group Name']; ?>">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">User Group Name:</label>
                                    <input class="form-control" id="GroupName" type="text" value="<?Php echo $GroupData[0]['User Group Name']; ?>">
                                    <div id="ErrorGroupName" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorGroupNameText"></span>
                                    </div>
                                </div>
                            </div>
                            <!-- Button Group Start -->
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="UpdateGroup" class="button button-outline button-primary">Save</button>
