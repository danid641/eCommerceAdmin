...
<?Php require_once 'assets/php/logs.php'; $logs = new Logs; ?>
<?php
                    ...
                    <div class="invoice-head">
                        ...
                        <div class="d-flex justify-content-between row mbn-20">
                            ...
                            <div class="text-left col-12 col-sm-auto mb-20">
                                ...
                                <p>77 seventh south center <br>USA North Road -2455. <br> +112 666 4558 99 <br> info@adomx.com
                                </p>
                            </div>
                            <!--Invoice To-->
                            <div class="text-left text-sm-right col-12 col-sm-auto mb-20">
                                <h4 class="fw-600">Tyler Meyer</h4>
                                <p>25 seventh North center <br>USA South Road -3125. <br> +112 666 4558 99 <br> info@adomx.com
                                </p>
                                <p><span class="text-heading fw-600">Invoice Date:</span> 11 March 2019 <br>
                                    <span class="text-heading fw-600">Due Date:</span> 20 April 2019</p>
                            </div>
                        </div>
                    </div>
                </div>
