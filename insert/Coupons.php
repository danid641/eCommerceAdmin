                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-12 col-12 mb-30">
                                ...
                                <input class="form-control" id="CouponName" type="text" placeholder="">
                                <div id="ErrorCouponName" class="mt-5" style="display: none;">
                                    <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                    <span class="text-danger mb-5" id="ErrorCouponNameText"></span>
                                </div>
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                                ...
                                <div id="ErrorCode" class="mt-5" style="display: none;">
                                    <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                    <span class="text-danger mb-5" id="ErrorCodeText"></span>
                                </div>
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                                <label for="">Coupon Description:</label>
                                <textarea class="form-control" id="CouponDescription" type="number" placeholder=""></textarea>
                                <div id="ErrorCouponDescription" class="mt-5" style="display: none;">
                                    <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                    <span class="text-danger mb-5" id="ErrorCouponDescriptionText"></span>
                                </div>
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                            ...
                            <div class="col-lg-12 col-12 mb-30">
                                ...
                                <input class="form-control" id="Discount" type="number" value="0.00" placeholder="">
                                <div id="ErrorDiscount" class="mt-5" style="display: none;">
                                    <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                    <span class="text-danger mb-5" id="ErrorDiscountText"></span>
                                </div>
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                            ...
                            <div class="col-lg-12 col-12 mb-30">
                                ...
                                <input class="form-control" id="DateStart" type="date" placeholder="">
                                <div id="ErrorDateStart" class="mt-5" style="display: none;">
                                    <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                    <span class="text-danger mb-5" id="ErrorDateStartText"></span>
                                </div>
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                                <label for="">Date End:</label>
                                <input class="form-control" id="DateEnd" type="date" placeholder="">
                                <div id="ErrorDateEnd" class="mt-5" style="display: none;">
                                    <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                    <span class="text-danger mb-5" id="ErrorDateEndText"></span>
                                </div>
                            </div>
                            <div class="col-lg-12 col-12 mb-30">
                        ...
                        <div class="row">
                            <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                <button id="AddCupon" class="button button-outline button-primary">Save</button>
