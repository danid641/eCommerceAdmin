                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="Product-Form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 mb-30">
                                    <input class="form-control" id="ProductPrice" type="number" placeholder="Product Price">
                                ...
                                <div class="col-lg-6 col-12 mb-30">
                                    <input class="form-control" id="Stock" type="number" placeholder="Product Stock">
                                ...
                                <div class="col-lg-6 col-12 mb-30">
                                    <input class="form-control" id="ProductDiscount" type="number" placeholder="Discount: ex 20%" value="0">
                                    <div id="ErrorProductDiscount" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorProductDiscountText"></span>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12 mb-30">
                                ...
                                <div class="col-lg-6 col-12 mb-30">
                                    <input class="form-control" id="Tags" type="text" placeholder="Tags">
                            ...
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="AddProduct" class="button button-outline button-primary">Add Product</button>
