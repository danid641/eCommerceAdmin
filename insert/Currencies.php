                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30">
                                    ...
                                    <input class="form-control" id="CurrencyTitle" type="text" placeholder="">
                                    <div id="ErrorCurrencyTitle" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorCurrencyTitleText"></span>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                ...
                                <div class="col-lg-12 col-12 mb-30">
                                    ...
                                    <input class="form-control" id="Value" type="number" value="0.00" placeholder="">
                                    <div id="ErrorValue" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorValueText"></span>
                                    </div>
                                </div>
                            </div>
                            <!-- Button Group Start -->
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="AddCurrency" class="button button-outline button-primary">Save</button>
