...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            ...
            <?php if ($perm['permissions'][0]['catalog/Categories']['access'] == "true" && $perm['permissions'][0]['catalog/Categories']['modify'] == "true") { ?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30">
                                    ...
                                    <input class="form-control" id="CategoryName" type="text" placeholder="">
                                    <div id="ErrorCategoryName" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorCategoryNameText"></span>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Description:</label>
                                    <input class="form-control" id="Description" type="text" placeholder="">
                                    <div id="ErrorDescription" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorDescriptionText"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30">
                                    ...
                                    <input class="form-control" id="MetaTagKeywords" type="text" placeholder="">
                                    <div id="ErrorMetaTagKeywords" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorMetaTagKeywordsText"></span>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for="">Meta Tag Description:</label>
                                    <input class="form-control" id="MetaTagDescription" type="text" placeholder="">
                                    <div id="ErrorMetaTagDescription" class="mt-5" style="display: none;">
                                        <i class="fa-solid fa-circle-exclamation text-danger h4 mr-1"></i>
                                        <span class="text-danger mb-5" id="ErrorMetaTagDescriptionText"></span>
                                    </div>
                                </div>
                            </div>
                            <!-- Button Group Start -->
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="AddCategory" class="button button-outline button-primary">Save</button>
