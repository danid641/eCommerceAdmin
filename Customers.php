...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <?php if ($perm['permissions'][0]['sale/Customers']['access'] == "true") { ?>
                <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-vertical-middle">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?php echo $lang->words['Customers']['First Name']; ?></th>
                                        <th><?php echo $lang->words['Customers']['Last Name']; ?></th>
                                        <th><?php echo $lang->words['Customers']['username']; ?></th>
                                        <th><?php echo $lang->words['Customers']['Email']; ?></th>
                                        <th><?php echo $lang->words['Customers']['Phone']; ?></th>
                                        <th><?php echo $lang->words['Customers']['description']; ?></th>
                                        <th><?php echo $lang->words['Customers']['newsletter']; ?></th>
                                        <?php if ($perm['permissions'][0]['sale/Customers']['access'] == "true" && $perm['permissions'][0]['sale/Customers']['modify'] == "true") { ?>
                                            <th class="jsgrid-header-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
                                                <a href="insert/Customers.php"><i class="fa-solid fa-plus text-success h2 cursor-pointer"></i></a>
                                            </th>
                                        <?Php } ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $Customers->GetDataCustomers(); ?>
                                    <?php foreach ($Customers->CustomersData as $data) { ?>
                                        <tr data-CustomerColumnId="<?php echo $data['id']; ?>">
                                            ...
                                            <td>s<?Php echo $data['newsletter']; ?></td>
                                            <?php if ($perm['permissions'][0]['sale/Customers']['access'] == "true" && $perm['permissions'][0]['sale/Customers']['modify'] == "true") { ?>
                                                <td class="action h4">
                                                    <div class="table-action-buttons">
                                                        <a class="edit button button-box button-xs button-info" href="update/Customers.php?CustomerName=<?Php echo $data['username']; ?>">
