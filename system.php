...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <?php if ($perm['permissions'][0]['system/Settings/System']['access'] == "true" && $perm['permissions'][0]['system/Settings/System']['modify'] == "true") { ?>
                <!-- Add or Edit Product Start -->
                <div class="add-edit-product-wrap col-12">

                    <div class="add-edit-product-form">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <h4 class="title"><?php echo $lang->words['System']['Edit Settings']; ?></h4>
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['Control Panel Session Expiration']; ?>:</label>
                                    <input class="form-control" id="SessionExpiration" type="text">
                                </div>
                                <div class="col-lg-12  col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['Maintenance Mode']; ?>: </label>
                                ...
                                <div class="col-lg-12  col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['Cache enabled']; ?>:</label>
                                    <label class="adomx-switch primary">
                                ...
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['Resource Library Upload Max File Size, kB']; ?></label>
                                    <input class="form-control" id="Subject" type="text">
                                </div>
                                <div class="col-lg-12  col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['Display Errors']; ?>:</label>
                                    <label class="adomx-switch primary">
                                ...
                                <div class="col-lg-12  col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['Log Errors']; ?>:</label>
                                    <label class="adomx-switch primary">
                                ...
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['Error Log Filename']; ?>:</label>
                                    <input class="form-control" id="ErrorLogFilename" type="text">
                                </div>
                                <div class="col-lg-12 col-12 mb-30">
                                    <label for=""><?php echo $lang->words['System']['System Check']; ?>:</label>
                                    <select class="form-control select2" id="SystemCheck">
                                        <option value="">Disabled</option>
                                        <option value="">Admin & Storefront</option>
                            ...
                            <div class="row">
                                <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                    <button id="SaveSystemData" class="button button-outline button-primary">Save</button>
                                    <button id="SaveSystemData" class="button button-outline button-default ml-5">Reset</button>
                                </div>
                            </div>
                            <!-- Button Group End -->
